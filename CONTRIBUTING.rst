...
Welcome to ``nemo_eos`` contributor's guide.
...
If you experience bugs or general issues with ``nemo_eos``, please have a look
...
You can help improve ``nemo_eos`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``nemo_eos`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``nemo_eos``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n nemo_eos python=3 six virtualenv pytest pytest-cov
    conda activate nemo_eos
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/nemo_eos.git
    cd nemo_eos
...
#. Install |pre-commit|_::
   ...
   ``nemo_eos`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/nemo_eos
.. _issue tracker: https://github.com/<USERNAME>/nemo_eos/issues
.. <-- end -->
